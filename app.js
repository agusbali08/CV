...
"(667) 905-5001","1743 Preston Rd","2/4/1988","OBJECTIVE","",
"EDUCATION","GRADUATION","","INTERMEDIATE","","MATRICULATION","",
...
function mydetails(name,det,gmail,phone,adrs,birthday,headobj,objective,headedu,matric,school,inter,college,grad,uni,headexp,work,hospital,
...
function blueclr(){
    ...
    document.getElementById("cpyrt").style.backgroundColor= "#0800FF";
